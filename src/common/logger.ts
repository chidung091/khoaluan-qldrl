...
export function errorLog(data?: any, customMessage?: string, userId?: string): void {
  log(LogLevel.Error, data, customMessage, userId);
}

export function debugLog(data?: any, customMessage?: string, userId?: string): void {
  log(LogLevel.Debug, data, customMessage, userId);
}

export function infoLog(data?: any, customMessage?: string, userId?: string): void {
  log(LogLevel.Info, data, customMessage, userId);
}

export function critLog(data?: any, customMessage?: string, userId?: string): void {
...
function log(logLevel: LogLevel, data?: any, customMessage = 'LOG', userId?: string): void {
  if (logEnabled) {
    try {
      switch (logLevel) {
        case LogLevel.Debug:
